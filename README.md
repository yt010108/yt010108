...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,bash,c,php,docker,linux,git,github" alt="Python, Bash, C, PHP, Docker, Linux, Git, GitHub" />
</p>
...
| :--- | :--- | :---: |
| [IXWebSocket](https://github.com/machinezone/IXWebSocket) | Reported a path traversal vulnerability in the default `HttpServer` callback; the upstream fix credits the report. | [Commit](https://github.com/machinezone/IXWebSocket/commit/5da103b0da9183757301ea1676b26795a996e443) |

### Study Group

| Group | Summary | Topics | Code |
| :--- | :--- | :---: | :---: |
